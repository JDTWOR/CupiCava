...
public class CupiCava {
   ...
   * <b>pre:</b> La lista de vinos est� inicializada.
   * 
   * @param pTipo Tipo de vino de acuerdo a su contenido en az�car.pTipo != null
  ...
  public boolean agregarVino(String pNombre, String pPresentacion, int pAnhoElaboracion, double pContenidoAzucar,
    ...
    if (buscado == null) {
      Vino vino = new Vino(pNombre, pPresentacion, pAnhoElaboracion, pContenidoAzucar, pTipo, pColor, pLugarOrigen,
          pImagen);
      vinos.add(vino);
      agregada = true;
    }
   ...
   * algoritmo de inserci�n. <br>
   * <b>pre:</b> La lista de vinos est� inicializada.<br>
   * <b> post: </b>La lista de vinos est� ordenada por lugar de origen (orden
   * ascendente).
   */
